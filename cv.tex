...
% Sidebar width and padding to make the column visible
\newcommand{\sidebarpad}{0.5cm}
% Include page margin so the sidebar spans the visible right column plus padding
\newcommand{\sidebarwidth}{\dimexpr\rightcolwidth+\sidebarpad+\pagemargin\relax}
