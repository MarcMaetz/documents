...
\begin{minipage}[t]{\leftcolwidth}
  ...
  \boxedcontent{%
    ...
    \begin{itemize}[leftmargin=*, itemsep=2pt]
      \item Scaled by 100x a cloud-native microservice backend for a smart card payment platform
      \item Proxy leadership of 2 engineers during absence of lead engineer
      \item Introduced in support tools firebase API for faster incident resolution and 60\% reduction of code for 3 engineers
      \item Audited 1,000 ledgers to detect sequence inconsistencies, generating a complete ticket base to address all identified issues
