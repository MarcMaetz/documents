...
% Shared page margins
\newcommand{\leftmarginone}{0.9cm}
\newcommand{\rightmarginone}{1.0cm}
\newcommand{\bottommarginone}{0.5cm}
\newcommand{\topmarginone}{0.2cm}

\usepackage[top=\topmarginone, bottom=\bottommarginone, left=\leftmarginone, right=\rightmarginone]{geometry}
\usepackage{tikz}
...
\setlist[itemize]{leftmargin=8pt, itemsep=1pt, topsep=0pt, labelsep=3pt, label=\raisebox{0.25ex}{\scalebox{0.7}{\textbullet}}}
...
\newcommand{\sidebarwidth}{\dimexpr\rightcolwidthabs+\colgapabs/6+\rightmarginone\relax}
...
% Icon item: icon + content in aligned minipages
% Usage: \iconitem{icon}{content}
